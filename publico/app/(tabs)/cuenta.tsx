...
export default function Perfil() {
  ...
  const cargarDatosUsuario = async () => {
    try {
      ...
      console.log("Carnet RAW:", JSON.stringify(userData.carnet));
  ...
  const handleDownloadCv = async () => {
    ...
    try {
      ...
      setCvErrorMessage(
        "No se pudo abrir el CV. Verifica la conexión al servidor.",
      );
      setCvErrorVisible(true);
    }
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentBackground}>
        ...
        <View style={styles.infoGrid}>
          ...
          <View style={styles.infoItem}>
            ...
            <Text style={styles.value}>
              {usuario.disponibilidad || "No especificada"}
            </Text>
          </View>
        </View>
      ...
      <Portal>
        ...
        >
          ...
          <Dialog.Content>
            <Paragraph style={styles.dialogText}>{cvErrorMessage}</Paragraph>
          </Dialog.Content>
          <Dialog.Actions style={styles.dialogActions}>
            <Button
